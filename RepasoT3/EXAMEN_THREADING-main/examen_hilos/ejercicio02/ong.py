#Para este ejercicio uso el método de sincronización 'Condition', mediante el que los hilos esperan a que se cumpla una condición antes de acceder a la sección crítica.
#Condition también sirve para hacer que, en caso de no cumplirse dicha condición, los hilos esperen hasta que se cumpla.
#En este caso, he creado dos clases, una para hilos Voluntarios y otra para hilos Gestores, que comparten tanto la cantidad de dinero recaudado como el Condition().
#De esta forma, los cambios de un hilo a estas variables podrán ser vistos por los de la otra clase y viceversa, permitiendo así que todos los hilos se coordinen.
